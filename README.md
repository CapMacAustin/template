...
Site for test content: https://capmacusersgroup.squarespace.com

Command for running development server with test content:

```bash
squarespace-server https://capmacusersgroup.squarespace.com --auth
```
...
Some polyfills are [provided by squarespace](https://github.com/Squarespace/squarespace-polyfills):
  - CustomEvent
  - Element.matches
  - Element.closest
